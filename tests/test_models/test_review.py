...
class TestReview(unittest.TestCase):
    ...
    def test_iscorrecttype(self):
        ...
        self.assertIs(type(working_obj.place_id), str)
        self.assertIs(type(working_obj.user_id), str)
        self.assertIs(type(working_obj.text), str)
    ...
    def test_executable_file(self):
        ...
        can_be_exec = os.access('models/Review.py', os.X_OK)
    ...
    def test_kwargs(self):
        ...
        my_object_kwargs = Review(**my_object_json)
    ...
    def test_des_and_serialization(self):
        ...
        self.my_object.text = "Awesome place to hang with the dudes"
        self.my_object.my_number = 3333333
        self.my_object.save()
        with open("file.json", "r", encoding='utf-8') as f:
            self.assertTrue(self.my_object.text in f.read())  # Test save
