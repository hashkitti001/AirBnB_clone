...
class TestCity(unittest.TestCase):
    ...
    def test_docStringsExist(self):
        ...
        self.assertIsNotNone(City.__doc__, class_msg)
        meth_msg = "Method doesn't have a docstring"
    
    def test_instancehasid(self):
        '''Checks if the instance of the City class has an id'''
    ...
    def test_iscorrecttype(self):
        '''Checks if the attributes of the City object are the right data type'''
    ...
    def test_executable_file(self):
        ...
        can_be_exec = os.access('models/city.py', os.X_OK)
