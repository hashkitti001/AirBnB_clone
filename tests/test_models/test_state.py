...
class TestState(unittest.TestCase):
    ...
    def test_docStringsExist(self):
        ...
        self.assertIsNotNone(State.__doc__, class_msg)
        meth_msg = "Method doesn't have a docstring"
        
    def test_instancehasid(self):
        '''Checks if the instance of the State class has an id'''
    ...
    def test_iscorrecttype(self):
        '''Checks if the attributes of the State object are the right data type'''
    ...
    def test_executable_file(self):
        ...
        can_be_exec = os.access('models/state.py', os.X_OK)
    ...
    def test_des_and_serialization(self):
        ...
        self.my_object.name = "Kansas"
        self.my_object.my_number = 44444599
        self.my_object.save()
